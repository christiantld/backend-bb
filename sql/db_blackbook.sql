...
-- -----------------------------------------------------
-- Table `db_blackbook`.`tb_produto_fornecedor`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `db_blackbook`.`tb_produto_fornecedor` ;

CREATE TABLE
IF NOT EXISTS `db_blackbook`.`tb_produto_fornecedor`
(
...
(`Pk_produto_fornecedor`),
  CONSTRAINT `fk_tb_produto_fornecedor_tb_produto1`
    FOREIGN KEY
(`pk_produto`)
    REFERENCES `db_blackbook`.`tb_produto`
(`pk_produto`)
...
DELETE NO ACTION
    ON
UPDATE NO ACTION,
  CONSTRAINT `fk_tb_produto_fornecedor_tb_fornecedor1`
    FOREIGN KEY
(`pk_fornecedor`)
    REFERENCES `db_blackbook`.`tb_fornecedor`
(`pk_fornecedor`)
...
CREATE INDEX `fk_tb_produto_fornecedor_tb_produto1_idx` ON `db_blackbook`.`tb_produto_fornecedor`
(`pk_produto`);

CREATE INDEX `fk_tb_produto_fornecedor_tb_fornecedor1_idx` ON `db_blackbook`.`tb_produto_fornecedor`
(`pk_fornecedor`);
